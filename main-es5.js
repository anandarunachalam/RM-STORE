...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_hf_card_list_hf_card_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./components/hf-card-list/hf-card-list.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_components_hf_card_list_hf_card_list_component__WEBPACK_IMPORTED_MODULE_1__["HfCardListComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_shared_humanfinder_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../app/shared/humanfinder.module */
    "./src/app/shared/humanfinder.module.ts");
    /* harmony import */


    var _services_hf_list_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./services/hf-list.service */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _app_shared_humanfinder_module__WEBPACK_IMPORTED_MODULE_4__["HumanFinderModule"]]]
    });
  ...
  /***/
  function srcAppComponentsHfCardListHfCardListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HfCardListComponent", function () {
      return HfCardListComponent;
    });
    /* harmony import */
    ...
    var _services_hf_list_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../services/hf-list.service */
    "./src/app/services/hf-list.service.ts");
    /* harmony import */
    ...
    var _hf_filter_block_hf_filter_block_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../hf-filter-block/hf-filter-block.component */
    ...
    var _hf_pagination_block_hf_pagination_block_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../hf-pagination-block/hf-pagination-block.component */
    ...
    var _hf_chips_list_hf_chips_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../hf-chips-list/hf-chips-list.component */
    ...
    var _pipes_hf_sort_pipe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../../pipes/hf-sort.pipe */
    "./src/app/pipes/hf-sort.pipe.ts");

    function HfCardListComponent_mat_chip_list_10_app_hf_chips_list_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-hf-chips-list", 22);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("removeFilter", function HfCardListComponent_mat_chip_list_10_app_hf_chips_list_1_Template_app_hf_chips_list_removeFilter_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r5.filterChange($event);
        });
    ...
    function HfCardListComponent_mat_chip_list_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HfCardListComponent_div_26_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var HfCardListComponent =
    /*#__PURE__*/
    function () {
      function HfCardListComponent(_rmsService) {
        _classCallCheck(this, HfCardListComponent);
      ...
      _createClass(HfCardListComponent, [{
        key: "ngOnInit",
        ...
        value: function getAllCharacters(page) {
          var _this = this;

          var query = '';

          if (this.selectedFilter.length > 0) {
            this.selectedFilter.forEach(function (item) {
          ...
          this._rmsService.getAllCharacters(page, query).subscribe(function (res) {
            _this.page.count = res.info.count;
            _this.page.pages = res.info.pages;
            _this.allCharacters = res.results;
          }, function (err) {});
        }
      }, {
        key: "filterChange",
        value: function filterChange(evt) {
          ...
          var index = this.selectedFilter.findIndex(function (sFilter) {
            return sFilter.item === evt.item;
          });

          if (index === -1) {
            this.selectedFilter.push(evt);
          } else {
            var mainCat = this.filterList.find(function (item) {
              return item.name === _this2.selectedFilter[index].name.name;
            });
            var subItem = mainCat.items.find(function (sItem) {
              return sItem.name === _this2.selectedFilter[index].item.name;
            });
        ...
        key: "sortingOnChange",
        value: function sortingOnChange(val) {
          this.sortOrder = val;
          this.allCharacters = _toConsumableArray(this.allCharacters);
        }
      }]);
    ...
    HfCardListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HfCardListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("filterChange", function HfCardListComponent_Template_app_hf_filter_block_filterChange_4_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HfCardListComponent_Template_input_ngModelChange_15_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HfCardListComponent_Template_button_click_16_listener() {
            return ctx.getAllCharacters(ctx.page.currentpage);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function HfCardListComponent_Template_select_change_20_listener($event) {
            return ctx.sortOrder = $event.target.value;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("prev", function HfCardListComponent_Template_app_hf_pagination_block_prev_29_listener($event) {
            return ctx.goToPage($event);
          })("next", function HfCardListComponent_Template_app_hf_pagination_block_next_29_listener($event) {
            return ctx.goToPage($event);
          })("goPage", function HfCardListComponent_Template_app_hf_pagination_block_goPage_29_listener($event) {
            return ctx.goToPage($event);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HfCardListComponent, [{
        ...
        return [{
          type: _services_hf_list_service__WEBPACK_IMPORTED_MODULE_1__["RmsShowService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppComponentsHfChipsListHfChipsListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HfChipsListComponent", function () {
      return HfChipsListComponent;
    });
    /* harmony import */
    ...
    var HfChipsListComponent =
    /*#__PURE__*/
    function () {
      function HfChipsListComponent() {
        _classCallCheck(this, HfChipsListComponent);

        this.removeFilter = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }

      _createClass(HfChipsListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "removeChip",
    ...
    HfChipsListComponent.ɵfac = function HfChipsListComponent_Factory(t) {
      return new (t || HfChipsListComponent)();
    };

    HfChipsListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HfChipsListComponent,
      selectors: [["app-hf-chips-list"]],
      inputs: {
      ...
      decls: 4,
      vars: 1,
      consts: [[1, "p-l-5", 3, "click"]],
      template: function HfChipsListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HfChipsListComponent_Template_span_click_2_listener() {
            return ctx.removeChip();
          });
  ...
  /***/
  function srcAppComponentsHfFilterBlockHfFilterBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HfFilterBlockComponent", function () {
      return HfFilterBlockComponent;
    });
    /* harmony import */
    ...
    function HfFilterBlockComponent_div_0_mat_checkbox_3_Template(rf, ctx) {
      if (rf & 1) {
        var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-checkbox", 3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HfFilterBlockComponent_div_0_mat_checkbox_3_Template_mat_checkbox_ngModelChange_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var item_r11 = ctx.$implicit;
          return item_r11.selected = $event;
        })("change", function HfFilterBlockComponent_div_0_mat_checkbox_3_Template_mat_checkbox_change_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var item_r11 = ctx.$implicit;

          var f_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r14.toggleFilter(f_r9, item_r11);
        });
    ...
    function HfFilterBlockComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var HfFilterBlockComponent =
    /*#__PURE__*/
    function () {
      function HfFilterBlockComponent() {
        _classCallCheck(this, HfFilterBlockComponent);

        this.filterChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }

      _createClass(HfFilterBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "toggleFilter",
        value: function toggleFilter(f, item) {
          var data = {
            name: f,
            item: item
          };
    ...
    HfFilterBlockComponent.ɵfac = function HfFilterBlockComponent_Factory(t) {
      return new (t || HfFilterBlockComponent)();
    };

    HfFilterBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HfFilterBlockComponent,
      selectors: [["app-hf-filter-block"]],
      inputs: {
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "f-container", "fxLayout", "column", 4, "ngFor", "ngForOf"], ["fxLayout", "column", 1, "f-container"], [3, "ngModel", "ngModelChange", "change", 4, "ngFor", "ngForOf"], [3, "ngModel", "ngModelChange", "change"]],
      template: function HfFilterBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HfFilterBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsHfPaginationBlockHfPaginationBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HfPaginationBlockComponent", function () {
      return HfPaginationBlockComponent;
    });
    /* harmony import */
    ...
    var HfPaginationBlockComponent =
    /*#__PURE__*/
    function () {
      function HfPaginationBlockComponent() {
        _classCallCheck(this, HfPaginationBlockComponent);
      ...
      _createClass(HfPaginationBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "goToPage",
    ...
    HfPaginationBlockComponent.ɵfac = function HfPaginationBlockComponent_Factory(t) {
      return new (t || HfPaginationBlockComponent)();
    };

    HfPaginationBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HfPaginationBlockComponent,
      selectors: [["app-hf-pagination-block"]],
      inputs: {
      ...
      template: function HfPaginationBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HfPaginationBlockComponent_Template_button_click_7_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HfPaginationBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppDirectivesHumanFinderDirectiveTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPipesHfSortPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(SortPipe, [{
        key: "getComparer",
        value: function getComparer(attrName) {
        ...
        key: "getDescendigComparer",
        value: function getDescendigComparer(comparer) {
        ...
        value: function transform(data) {
          var attrName = arguments.length <= 1 ? undefined : arguments[1];
          var sort = arguments.length <= 2 ? undefined : arguments[2];
          if (!data || !data.length || !attrName) return data; // let comparer = this.getComparer(attrName);
          // if (isDesc)
  ...
  /***/
  function srcAppPipesHfTimePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ElaspedTimePipe", function () {
      return ElaspedTimePipe;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function ElaspedTimePipe() {
        _classCallCheck(this, ElaspedTimePipe);
      }

      _createClass(ElaspedTimePipe, [{
        key: "transform",
        value: function transform(data) {
    ...
    ElaspedTimePipe.ɵfac = function ElaspedTimePipe_Factory(t) {
      return new (t || ElaspedTimePipe)();
    };

    ElaspedTimePipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "elaspedTime",
      type: ElaspedTimePipe,
      pure: true
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ElaspedTimePipe, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
        args: [{
          name: 'elaspedTime'
        }]
  ...
  /***/
  function srcAppServicesHfListServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RmsShowService", function () {
      return RmsShowService;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function RmsShowService(_http) {
        _classCallCheck(this, RmsShowService);

        this._http = _http;
      }

      _createClass(RmsShowService, [{
        key: "getAllFilterList",
        value: function getAllFilterList() {
          var filter = [{
            name: 'Species',
            items: [{
              name: 'Human',
        ...
        key: "getAllCharacters",
        value: function getAllCharacters(page, query) {
          var queryString = query.length > 0 ? page + query : page;
    ...
    RmsShowService.ɵfac = function RmsShowService_Factory(t) {
      return new (t || RmsShowService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]));
    };

    RmsShowService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: RmsShowService,
      factory: RmsShowService.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RmsShowService, [{
  ...
  /***/
  function srcAppSharedHumanfinderModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HumanFinderModule", function () {
      return HumanFinderModule;
    });
    /* harmony import */
    ...
    var _pipes_hf_sort_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../pipes/hf-sort.pipe */
    "./src/app/pipes/hf-sort.pipe.ts");
    /* harmony import */


    var _pipes_hf_time_pipe__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../pipes/hf-time.pipe */
    "./src/app/pipes/hf-time.pipe.ts");
    /* harmony import */


    var _directives_human_finder_directive__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../directives/human-finder.directive */
    "./src/app/directives/human-finder.directive.ts");
    /* harmony import */


    var _components_hf_card_list_hf_card_list_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ../components/hf-card-list/hf-card-list.component */
    "./src/app/components/hf-card-list/hf-card-list.component.ts");
    /* harmony import */


    var _components_hf_chips_list_hf_chips_list_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../components/hf-chips-list/hf-chips-list.component */
    "./src/app/components/hf-chips-list/hf-chips-list.component.ts");
    /* harmony import */


    var _components_hf_filter_block_hf_filter_block_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ../components/hf-filter-block/hf-filter-block.component */
    "./src/app/components/hf-filter-block/hf-filter-block.component.ts");
    /* harmony import */


    var _components_hf_pagination_block_hf_pagination_block_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ../components/hf-pagination-block/hf-pagination-block.component */
    "./src/app/components/hf-pagination-block/hf-pagination-block.component.ts");

    var HumanFinderModule = function HumanFinderModule() {
      _classCallCheck(this, HumanFinderModule);
    };

    HumanFinderModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: HumanFinderModule
    });
    HumanFinderModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function HumanFinderModule_Factory(t) {
        return new (t || HumanFinderModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_6__["MatDividerModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_7__["MatListModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_11__["MatChipsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_6__["MatDividerModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_7__["MatListModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_11__["MatChipsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HumanFinderModule, {
        declarations: [_components_hf_card_list_hf_card_list_component__WEBPACK_IMPORTED_MODULE_15__["HfCardListComponent"], _components_hf_chips_list_hf_chips_list_component__WEBPACK_IMPORTED_MODULE_16__["HfChipsListComponent"], _components_hf_filter_block_hf_filter_block_component__WEBPACK_IMPORTED_MODULE_17__["HfFilterBlockComponent"], _components_hf_pagination_block_hf_pagination_block_component__WEBPACK_IMPORTED_MODULE_18__["HfPaginationBlockComponent"], _pipes_hf_time_pipe__WEBPACK_IMPORTED_MODULE_13__["ElaspedTimePipe"], _pipes_hf_sort_pipe__WEBPACK_IMPORTED_MODULE_12__["SortPipe"], _directives_human_finder_directive__WEBPACK_IMPORTED_MODULE_14__["HighLightDirective"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_6__["MatDividerModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_7__["MatListModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_11__["MatChipsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]],
        exports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_6__["MatDividerModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_7__["MatListModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_11__["MatChipsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _pipes_hf_time_pipe__WEBPACK_IMPORTED_MODULE_13__["ElaspedTimePipe"], _pipes_hf_sort_pipe__WEBPACK_IMPORTED_MODULE_12__["SortPipe"], _directives_human_finder_directive__WEBPACK_IMPORTED_MODULE_14__["HighLightDirective"], _components_hf_card_list_hf_card_list_component__WEBPACK_IMPORTED_MODULE_15__["HfCardListComponent"], _components_hf_chips_list_hf_chips_list_component__WEBPACK_IMPORTED_MODULE_16__["HfChipsListComponent"], _components_hf_filter_block_hf_filter_block_component__WEBPACK_IMPORTED_MODULE_17__["HfFilterBlockComponent"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HumanFinderModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_components_hf_card_list_hf_card_list_component__WEBPACK_IMPORTED_MODULE_15__["HfCardListComponent"], _components_hf_chips_list_hf_chips_list_component__WEBPACK_IMPORTED_MODULE_16__["HfChipsListComponent"], _components_hf_filter_block_hf_filter_block_component__WEBPACK_IMPORTED_MODULE_17__["HfFilterBlockComponent"], _components_hf_pagination_block_hf_pagination_block_component__WEBPACK_IMPORTED_MODULE_18__["HfPaginationBlockComponent"], _pipes_hf_time_pipe__WEBPACK_IMPORTED_MODULE_13__["ElaspedTimePipe"], _pipes_hf_sort_pipe__WEBPACK_IMPORTED_MODULE_12__["SortPipe"], _directives_human_finder_directive__WEBPACK_IMPORTED_MODULE_14__["HighLightDirective"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_6__["MatDividerModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_7__["MatListModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_11__["MatChipsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\ANAND-DRIVE\Angular Sapient Training\human-finder\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
